...
import LanguageSelector from '#presenter/components/language/LanguageSelector.vue'
...
const showAuthentication = !!props.auth.AUTHORITY_SIGNUP_URI
...
async function signUp() {
  window.location.href = props.auth.AUTHORITY_SIGNUP_URI
}

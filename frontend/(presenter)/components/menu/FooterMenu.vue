  ...
  <div>
    <v-footer color="#f5f5f5" dark class="justify-center">
      <v-row justify="center" class="my-4 justify-space-around footer">
        ...
        <v-col cols="6" md="3">
          <h2 class="footer-header mb-6 text-left">{{ $t('menu.footer.privacyHeadline') }}</h2>
          <div class="footer-links">
        ...
        <v-col cols="12" md="6">
          <h2 class="footer-header mb-10 text-left">{{ $t('menu.footer.contact') }}</h2>
          <div>
            <ContactForm />
          </div>
        </v-col>
...
import ContactForm from '#presenter/components/forms/ContactForm.vue'
import LogoImage from '#presenter/components/LogoImage.vue'
import AnchorLink from '#presenter/components/nav/AnchorLink.vue'
</script>

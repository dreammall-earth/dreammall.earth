...
import LargeDreamMallButton from '#app/components/buttons/LargeDreamMallButton.vue'
import SmallDreamMallButton from '#app/components/buttons/SmallDreamMallButton.vue'
import TableSetup from '#app/components/malltalk/setup/TableSetup.vue'
import Circle from '#app/components/menu/CircleElement.vue'
import LightDarkSwitch from '#app/components/menu/LightDarkSwitch.vue'
import LogoImage from '#app/components/menu/LogoImage.vue'
import TabControl from '#app/components/menu/TabControl.vue'
import UserInfo from '#app/components/menu/UserInfo.vue'
import ModalPanel from '#app/components/modal/ModalPanel.vue'
import useModal from '#app/components/modal/useModal'
import TablesDrawer from '#app/components/tablesDrawer/TablesDrawer.vue'

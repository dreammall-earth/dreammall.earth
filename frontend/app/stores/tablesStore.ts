...
import { createMyTableMutation } from '#app/graphql/mutations/createMyTableMutation'
import { createTableMutation } from '#app/graphql/mutations/createTableMutation'
import { deleteTableMutation } from '#app/graphql/mutations/deleteTableMutation'
import { joinMyTableMutation } from '#app/graphql/mutations/joinMyTableMutation'
import { updateMyTableMutation } from '#app/graphql/mutations/updateMyTableMutation'
import { openTablesQuery } from '#app/graphql/queries/openTablesQuery'
import { tablesQuery } from '#app/graphql/queries/tablesQuery'
import { updateOpenTablesSubscription } from '#app/graphql/subscriptions/updateOpenTablesSubscription'
...
export const useTablesStore = defineStore(
  ...
  () => {
    ...
    */
    ...
    const getTableUri = (id: number): string => `/app/table/${id}`
    const getJoinTableUri = (id: number): string => `/app/join-table/${id}`

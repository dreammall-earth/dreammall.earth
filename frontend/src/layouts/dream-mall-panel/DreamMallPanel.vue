...
import InvitationSteps from '#layouts/malltalk/invitation/InvitationSteps.vue'
import TableSettings from '#layouts/malltalk/settings/TableSettings.vue'
import TableSetup from '#layouts/malltalk/setup/TableSetup.vue'
import { Call, useTablesStore } from '#stores/tablesStore'

import DreamMallButton from './DreamMallButton.vue'

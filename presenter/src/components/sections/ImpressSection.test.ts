...
describe('ImpressSection', () => {
  ...
  it('renders 7 cards', () => {
    ...
    expect(wrapper.findAll('.impress-section .content-card')).toHaveLength(7)
  })
  ...
  describe('seventh card', () => {
    it('has h2 impress.legalDisclaimer.headline', () => {
      expect(
        wrapper.findAll('.impress-section .content-card')[6].find('h2.card-header').text(),
      ).toBe("$t('impress.legalDisclaimer.headline')")
    })

    it('has p impress.legalDisclaimer.content', () => {
      expect(
        wrapper.findAll('.impress-section .content-card')[6].find('p.card-content').text(),

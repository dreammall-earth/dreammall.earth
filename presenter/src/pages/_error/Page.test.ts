  ...
  describe('500 Error', () => {
    ...
    describe('no is404 property set', () => {
      it('renders error 500', () => {
        expect(wrapper.find('h1').text()).toStrictEqual("$t('error.500.h1')")
        expect(wrapper.find('p').text()).toStrictEqual("$t('error.500.text')")
      })
    })
  ...
  describe('404 Error', () => {
    ...
    describe('is404 property is true', () => {
      it('renders error 400', () => {
        expect(wrapper.find('h1').text()).toStrictEqual("$t('error.404.h1')")
        expect(wrapper.find('p').text()).toStrictEqual("$t('error.404.text')")
      })
    })
  })
})
